 ...
 * @author noeli
 */
public class VuelosPanelCRUD extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VuelosPanelCRUD
     */
    public VuelosPanelCRUD() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VuelosPanelCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VuelosPanelCRUD().setVisible(true);
            }
        });
    }
